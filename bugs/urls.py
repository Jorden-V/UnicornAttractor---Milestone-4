...
from .views import view_bugs, bug_detail, upvote_bug, add_or_edit_bug, delete_bug, view_completed_bugs, delete_bug_comment, edit_bug_comment
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/edit_bug_comment/$', edit_bug_comment, name="edit_bug_comment"),
]
